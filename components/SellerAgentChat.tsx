            ...
            <div className="flex-1 flex flex-col">
              <div className="flex-1 flex flex-col items-center justify-center px-6">
                ...
                <h2 className="text-gray-900 text-lg font-semibold mb-1 text-center">
                  Olá{userName ? <>, <span>{userName.split(' ')[0]}</span></> : ''}! Sou seu assistente pessoal.
                </h2>
                <p className="text-gray-400 text-xs text-center mb-6">Performance, reuniões, treinos e agenda</p>
                ...
                {/* Quick suggestions as stacked cards */}
